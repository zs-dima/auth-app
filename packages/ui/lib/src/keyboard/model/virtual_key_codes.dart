// cspell:disable
// ignore_for_file: unused_element, unused_field, unused_local_variable, constant_identifier_names, prefer-correct-type-name
...
enum VK {
  ...
  static final Map<int, VK> _map = <int, VK>{for (final vk in values) vk.code: vk};
