...
///
/// hawkkiller/sizzle_starter Popup Widget
///
...
class _PopupBuilderState extends State<PopupBuilder> {
  ...
  void initState() {
    super.initState();
    _portalController = widget.controller ?? OverlayPortalController(debugLabel: 'Popup');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return EnhancedCompositedTransformTarget(
      ...
      child: OverlayPortal(
        ...
        child: widget.targetBuilder(context, _portalController),
        overlayChildBuilder: (context) => Center(
          child: EnhancedCompositedTransformFollower(
            ...
            child: widget.followerBuilder(context, _portalController),
          ),
        ),
      ),
    );
...
class _PopupFollowerState extends State<PopupFollower> with WidgetsBindingObserver implements PopupFollowerController {
  ...
  void _scrollableListener() {
    if (widget.onDismiss != null && widget.dismissOnScroll && _isRoot) {
  ...
  @override
  void dismiss() {
    if (widget.onDismiss != null && _isRoot) {
      widget.onDismiss?.call();
    }
  }
