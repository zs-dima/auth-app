...
const UserInfo$json = {
  '1': 'UserInfo',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 11, '6': '.core.v2.UUID', '10': 'id'},
...
final $typed_data.Uint8List userInfoDescriptor =
    $convert.base64Decode('CghVc2VySW5mbxIdCgJpZBgBIAEoCzINLmNvcmUudjIuVVVJRFICaWQSEgoEbmFtZRgCIAEoCV'
        'IEbmFtZRIUCgVlbWFpbBgDIAEoCVIFZW1haWwSFAoFcGhvbmUYBCABKAlSBXBob25lEiUKBHJv'
        'bGUYBSABKA4yES5jb3JlLnYyLlVzZXJSb2xlUgRyb2xlEisKBnN0YXR1cxgGIAEoDjITLmNvcm'
        'UudjIuVXNlclN0YXR1c1IGc3RhdHVzEh0KCmF2YXRhcl91cmwYByABKAlSCWF2YXRhclVybBIW'
...
final $typed_data.Uint8List userDescriptor =
    $convert.base64Decode('CgRVc2VyEh0KAmlkGAEgASgLMg0uY29yZS52Mi5VVUlEUgJpZBISCgRuYW1lGAIgASgJUgRuYW'
        '1lEhQKBWVtYWlsGAMgASgJUgVlbWFpbBIUCgVwaG9uZRgEIAEoCVIFcGhvbmUSJQoEcm9sZRgF'
        'IAEoDjIRLmNvcmUudjIuVXNlclJvbGVSBHJvbGUSKwoGc3RhdHVzGAYgASgOMhMuY29yZS52Mi'
...
const ListUsersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'user_ids', '3': 2, '4': 3, '5': 11, '6': '.core.v2.UUID', '10': 'userIds'},
    {'1': 'statuses', '3': 3, '4': 3, '5': 14, '6': '.core.v2.UserStatus', '10': 'statuses'},
    {'1': 'roles', '3': 4, '4': 3, '5': 14, '6': '.core.v2.UserRole', '10': 'roles'},
...
final $typed_data.Uint8List listUsersRequestDescriptor =
    $convert.base64Decode('ChBMaXN0VXNlcnNSZXF1ZXN0EiYKB3VzZXJfaWQYASABKAsyDS5jb3JlLnYyLlVVSURSBnVzZX'
        'JJZBIoCgh1c2VyX2lkcxgCIAMoCzINLmNvcmUudjIuVVVJRFIHdXNlcklkcxIvCghzdGF0dXNl'
        'cxgDIAMoDjITLmNvcmUudjIuVXNlclN0YXR1c1IIc3RhdHVzZXMSJwoFcm9sZXMYBCADKA4yES'
        '5jb3JlLnYyLlVzZXJSb2xlUgVyb2xlcxIeCgVxdWVyeRgFIAEoCUIIukgFcgMY/wFSBXF1ZXJ5'
...
final $typed_data.Uint8List createUserRequestDescriptor =
    $convert.base64Decode('ChFDcmVhdGVVc2VyUmVxdWVzdBIeCgRuYW1lGAEgASgJQgq6SAdyBRABGP8BUgRuYW1lEh4KBW'
        ...
        'IRLmNvcmUudjIuVXNlclJvbGVSBHJvbGUSHwoGbG9jYWxlGAYgASgJQge6SARyAhgjUgZsb2Nh'
...
const UpdateUserRequest$json = {
  '1': 'UpdateUserRequest',
  '2': [
    {'1': 'user_id', '3': 1, '4': 1, '5': 11, '6': '.core.v2.UUID', '8': {}, '10': 'userId'},
    ...
    {'1': 'role', '3': 6, '4': 1, '5': 14, '6': '.core.v2.UserRole', '9': 3, '10': 'role', '17': true},
    {'1': 'status', '3': 7, '4': 1, '5': 14, '6': '.core.v2.UserStatus', '9': 4, '10': 'status', '17': true},
...
final $typed_data.Uint8List updateUserRequestDescriptor =
    $convert.base64Decode('ChFVcGRhdGVVc2VyUmVxdWVzdBIuCgd1c2VyX2lkGAEgASgLMg0uY29yZS52Mi5VVUlEQga6SA'
        ...
        'GBBIAlIFcGhvbmWIAQESKgoEcm9sZRgGIAEoDjIRLmNvcmUudjIuVXNlclJvbGVIA1IEcm9sZY'
        'gBARIwCgZzdGF0dXMYByABKA4yEy5jb3JlLnYyLlVzZXJTdGF0dXNIBFIGc3RhdHVziAEBEiQK'
...
final $typed_data.Uint8List setPasswordRequestDescriptor =
    $convert.base64Decode('ChJTZXRQYXNzd29yZFJlcXVlc3QSLgoHdXNlcl9pZBgBIAEoCzINLmNvcmUudjIuVVVJREIGuk'
...
final $typed_data.Uint8List getAvatarUploadUrlRequestDescriptor =
    $convert.base64Decode('ChlHZXRBdmF0YXJVcGxvYWRVcmxSZXF1ZXN0Ei4KB3VzZXJfaWQYASABKAsyDS5jb3JlLnYyLl'
...
final $typed_data.Uint8List confirmAvatarUploadRequestDescriptor =
    $convert.base64Decode('ChpDb25maXJtQXZhdGFyVXBsb2FkUmVxdWVzdBIuCgd1c2VyX2lkGAEgASgLMg0uY29yZS52Mi'
...
final $typed_data.Uint8List deleteAvatarRequestDescriptor =
    $convert.base64Decode('ChNEZWxldGVBdmF0YXJSZXF1ZXN0Ei4KB3VzZXJfaWQYASABKAsyDS5jb3JlLnYyLlVVSURCBr'
        'pIA8gBAVIGdXNlcklk');
