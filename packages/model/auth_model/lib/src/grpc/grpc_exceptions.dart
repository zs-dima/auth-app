...
/// `ApiClientException`: both share the `Cancelled`/`Network`/`Authentication`/`Request`/`Server`
/// backbone, while HTTP additionally has `Internal`/`Timeout`, and [code] here is the raw
