...
class UserServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.UserInfo> listUsersInfo(
    ...
    return $createStreamingCall(
        _$listUsersInfo, $async.Stream.fromIterable([request]),
        options: options);
  }
  ...
  static final _$listUsersInfo =
      $grpc.ClientMethod<$0.ListUsersRequest, $0.UserInfo>(
  ...
  static final _$confirmAvatarUpload =
      $grpc.ClientMethod<$0.ConfirmAvatarUploadRequest, $1.Empty>(
  ...
  static final _$deleteAvatar =
      $grpc.ClientMethod<$0.DeleteAvatarRequest, $1.Empty>(
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAvatarUploadUrlRequest,
            $0.GetAvatarUploadUrlResponse>(
        'GetAvatarUploadUrl',
        getAvatarUploadUrl_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetAvatarUploadUrlRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ConfirmAvatarUploadRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.ConfirmAvatarUploadRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.DeleteAvatarRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.DeleteAvatarRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
  }

  $async.Stream<$0.UserInfo> listUsersInfo_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ListUsersRequest> $request) async* {
    yield* listUsersInfo($call, await $request);
  }

  $async.Stream<$0.UserInfo> listUsersInfo(
  ...
  $async.Future<$0.GetAvatarUploadUrlResponse> getAvatarUploadUrl_Pre(
      ...
      $async.Future<$0.GetAvatarUploadUrlRequest> $request) async {
  ...
  $async.Future<$1.Empty> confirmAvatarUpload_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ConfirmAvatarUploadRequest> $request) async {
    return confirmAvatarUpload($call, await $request);
  }

  $async.Future<$1.Empty> confirmAvatarUpload(
      $grpc.ServiceCall call, $0.ConfirmAvatarUploadRequest request);

  $async.Future<$1.Empty> deleteAvatar_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DeleteAvatarRequest> $request) async {
    return deleteAvatar($call, await $request);
  }

  $async.Future<$1.Empty> deleteAvatar(
      $grpc.ServiceCall call, $0.DeleteAvatarRequest request);
}
