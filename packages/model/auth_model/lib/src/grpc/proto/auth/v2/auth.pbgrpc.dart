...
/// =============================================================================
@$pb.GrpcServiceName('auth.v2.AuthService')
class AuthServiceClient extends $grpc.Client {
  ...
  static final _$authenticate =
      $grpc.ClientMethod<$0.AuthenticateRequest, $0.AuthResponse>(
  ...
  static final _$refreshTokens =
      $grpc.ClientMethod<$0.RefreshTokensRequest, $0.TokenPair>(
          '/auth.v2.AuthService/RefreshTokens',
          ($0.RefreshTokensRequest value) => value.writeToBuffer(),
          $0.TokenPair.fromBuffer);
  static final _$validateCredentials = $grpc.ClientMethod<
          $0.ValidateCredentialsRequest, $0.ValidateCredentialsResponse>(
      '/auth.v2.AuthService/ValidateCredentials',
  ...
  static final _$signUp = $grpc.ClientMethod<$0.SignUpRequest, $0.AuthResponse>(
      ...
      $0.AuthResponse.fromBuffer);
  static final _$verifyMfa =
      $grpc.ClientMethod<$0.VerifyMfaRequest, $0.AuthResponse>(
          '/auth.v2.AuthService/VerifyMfa',
          ($0.VerifyMfaRequest value) => value.writeToBuffer(),
          $0.AuthResponse.fromBuffer);
  static final _$getOAuthUrl =
      $grpc.ClientMethod<$0.GetOAuthUrlRequest, $0.GetOAuthUrlResponse>(
          '/auth.v2.AuthService/GetOAuthUrl',
          ($0.GetOAuthUrlRequest value) => value.writeToBuffer(),
          $0.GetOAuthUrlResponse.fromBuffer);
  static final _$exchangeOAuthCode =
      $grpc.ClientMethod<$0.ExchangeOAuthCodeRequest, $0.AuthResponse>(
          '/auth.v2.AuthService/ExchangeOAuthCode',
          ($0.ExchangeOAuthCodeRequest value) => value.writeToBuffer(),
          $0.AuthResponse.fromBuffer);
  static final _$linkOAuthProvider =
      $grpc.ClientMethod<$0.LinkOAuthProviderRequest, $1.Empty>(
          '/auth.v2.AuthService/LinkOAuthProvider',
          ($0.LinkOAuthProviderRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$unlinkOAuthProvider =
      $grpc.ClientMethod<$0.UnlinkOAuthProviderRequest, $1.Empty>(
          '/auth.v2.AuthService/UnlinkOAuthProvider',
          ($0.UnlinkOAuthProviderRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$listLinkedProviders = $grpc.ClientMethod<
          $0.ListLinkedProvidersRequest, $0.ListLinkedProvidersResponse>(
      '/auth.v2.AuthService/ListLinkedProviders',
      ($0.ListLinkedProvidersRequest value) => value.writeToBuffer(),
      $0.ListLinkedProvidersResponse.fromBuffer);
  static final _$recoveryStart =
      $grpc.ClientMethod<$0.RecoveryStartRequest, $1.Empty>(
          '/auth.v2.AuthService/RecoveryStart',
          ($0.RecoveryStartRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$recoveryConfirm =
      $grpc.ClientMethod<$0.RecoveryConfirmRequest, $1.Empty>(
  ...
  static final _$changePassword =
      $grpc.ClientMethod<$0.ChangePasswordRequest, $1.Empty>(
          ...
          $1.Empty.fromBuffer);
  static final _$requestVerification =
      $grpc.ClientMethod<$0.RequestVerificationRequest, $1.Empty>(
          '/auth.v2.AuthService/RequestVerification',
          ($0.RequestVerificationRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$confirmVerification =
      $grpc.ClientMethod<$0.ConfirmVerificationRequest, $0.AuthResponse>(
          '/auth.v2.AuthService/ConfirmVerification',
          ($0.ConfirmVerificationRequest value) => value.writeToBuffer(),
          $0.AuthResponse.fromBuffer);
  static final _$getMfaStatus =
      $grpc.ClientMethod<$0.GetMfaStatusRequest, $0.GetMfaStatusResponse>(
          '/auth.v2.AuthService/GetMfaStatus',
          ($0.GetMfaStatusRequest value) => value.writeToBuffer(),
          $0.GetMfaStatusResponse.fromBuffer);
  static final _$setupMfa =
      $grpc.ClientMethod<$0.SetupMfaRequest, $0.SetupMfaResponse>(
          '/auth.v2.AuthService/SetupMfa',
          ($0.SetupMfaRequest value) => value.writeToBuffer(),
          $0.SetupMfaResponse.fromBuffer);
  static final _$confirmMfaSetup =
      $grpc.ClientMethod<$0.ConfirmMfaSetupRequest, $0.ConfirmMfaSetupResponse>(
          '/auth.v2.AuthService/ConfirmMfaSetup',
          ($0.ConfirmMfaSetupRequest value) => value.writeToBuffer(),
          $0.ConfirmMfaSetupResponse.fromBuffer);
  static final _$disableMfa =
      $grpc.ClientMethod<$0.DisableMfaRequest, $1.Empty>(
          '/auth.v2.AuthService/DisableMfa',
          ($0.DisableMfaRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$listSessions =
      $grpc.ClientMethod<$0.ListSessionsRequest, $0.ListSessionsResponse>(
          '/auth.v2.AuthService/ListSessions',
          ($0.ListSessionsRequest value) => value.writeToBuffer(),
          $0.ListSessionsResponse.fromBuffer);
  static final _$revokeSession =
      $grpc.ClientMethod<$0.RevokeSessionRequest, $1.Empty>(
          '/auth.v2.AuthService/RevokeSession',
          ($0.RevokeSessionRequest value) => value.writeToBuffer(),
          $1.Empty.fromBuffer);
  static final _$revokeOtherSessions = $grpc.ClientMethod<
          $0.RevokeOtherSessionsRequest, $0.RevokeSessionsResponse>(
      '/auth.v2.AuthService/RevokeOtherSessions',
...
abstract class AuthServiceBase extends $grpc.Service {
  $core.String get $name => 'auth.v2.AuthService';
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ValidateCredentialsRequest,
            $0.ValidateCredentialsResponse>(
        'ValidateCredentials',
        validateCredentials_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ValidateCredentialsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.VerifyMfaRequest, $0.AuthResponse>(
        ...
        ($0.AuthResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetOAuthUrlRequest, $0.GetOAuthUrlResponse>(
            'GetOAuthUrl',
            getOAuthUrl_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetOAuthUrlRequest.fromBuffer(value),
            ($0.GetOAuthUrlResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.ExchangeOAuthCodeRequest, $0.AuthResponse>(
            'ExchangeOAuthCode',
    ...
    $addMethod($grpc.ServiceMethod<$0.LinkOAuthProviderRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.LinkOAuthProviderRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UnlinkOAuthProviderRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.UnlinkOAuthProviderRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ListLinkedProvidersRequest,
            $0.ListLinkedProvidersResponse>(
        'ListLinkedProviders',
        listLinkedProviders_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListLinkedProvidersRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.RecoveryStartRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.RecoveryStartRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RecoveryConfirmRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.RecoveryConfirmRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.RequestVerificationRequest, $1.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.RequestVerificationRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.ConfirmVerificationRequest, $0.AuthResponse>(
            'ConfirmVerification',
            ...
            ($0.AuthResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetMfaStatusRequest, $0.GetMfaStatusResponse>(
            'GetMfaStatus',
            getMfaStatus_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetMfaStatusRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ConfirmMfaSetupRequest,
            $0.ConfirmMfaSetupResponse>(
        'ConfirmMfaSetup',
        confirmMfaSetup_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ConfirmMfaSetupRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.RevokeSessionRequest, $1.Empty>(
        ...
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RevokeOtherSessionsRequest,
            $0.RevokeSessionsResponse>(
        'RevokeOtherSessions',
        revokeOtherSessions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RevokeOtherSessionsRequest.fromBuffer(value),
        ($0.RevokeSessionsResponse value) => value.writeToBuffer()));
  }

  $async.Future<$0.AuthResponse> authenticate_Pre($grpc.ServiceCall $call,
  ...
  $async.Future<$0.TokenPair> refreshTokens_Pre($grpc.ServiceCall $call,
      $async.Future<$0.RefreshTokensRequest> $request) async {
    return refreshTokens($call, await $request);
  }

  $async.Future<$0.TokenPair> refreshTokens(
  ...
  $async.Future<$0.ValidateCredentialsResponse> validateCredentials_Pre(
      ...
      $async.Future<$0.ValidateCredentialsRequest> $request) async {
  ...
  $async.Future<$1.Empty> signOut_Pre($grpc.ServiceCall $call,
  ...
  $async.Future<$0.AuthResponse> verifyMfa_Pre($grpc.ServiceCall $call,
      $async.Future<$0.VerifyMfaRequest> $request) async {
    return verifyMfa($call, await $request);
  }

  $async.Future<$0.AuthResponse> verifyMfa(
      $grpc.ServiceCall call, $0.VerifyMfaRequest request);

  $async.Future<$0.GetOAuthUrlResponse> getOAuthUrl_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GetOAuthUrlRequest> $request) async {
    return getOAuthUrl($call, await $request);
  }

  $async.Future<$0.GetOAuthUrlResponse> getOAuthUrl(
      $grpc.ServiceCall call, $0.GetOAuthUrlRequest request);

  $async.Future<$0.AuthResponse> exchangeOAuthCode_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ExchangeOAuthCodeRequest> $request) async {
    return exchangeOAuthCode($call, await $request);
  }

  $async.Future<$0.AuthResponse> exchangeOAuthCode(
      $grpc.ServiceCall call, $0.ExchangeOAuthCodeRequest request);

  $async.Future<$1.Empty> linkOAuthProvider_Pre($grpc.ServiceCall $call,
      $async.Future<$0.LinkOAuthProviderRequest> $request) async {
    return linkOAuthProvider($call, await $request);
  }

  $async.Future<$1.Empty> linkOAuthProvider(
      $grpc.ServiceCall call, $0.LinkOAuthProviderRequest request);

  $async.Future<$1.Empty> unlinkOAuthProvider_Pre($grpc.ServiceCall $call,
      $async.Future<$0.UnlinkOAuthProviderRequest> $request) async {
    return unlinkOAuthProvider($call, await $request);
  }

  $async.Future<$1.Empty> unlinkOAuthProvider(
      $grpc.ServiceCall call, $0.UnlinkOAuthProviderRequest request);

  $async.Future<$0.ListLinkedProvidersResponse> listLinkedProviders_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ListLinkedProvidersRequest> $request) async {
  ...
  $async.Future<$1.Empty> recoveryStart_Pre($grpc.ServiceCall $call,
      $async.Future<$0.RecoveryStartRequest> $request) async {
    return recoveryStart($call, await $request);
  }

  $async.Future<$1.Empty> recoveryStart(
      $grpc.ServiceCall call, $0.RecoveryStartRequest request);

  $async.Future<$1.Empty> recoveryConfirm_Pre($grpc.ServiceCall $call,
      $async.Future<$0.RecoveryConfirmRequest> $request) async {
    return recoveryConfirm($call, await $request);
  }

  $async.Future<$1.Empty> recoveryConfirm(
      $grpc.ServiceCall call, $0.RecoveryConfirmRequest request);
  ...
  $async.Future<$1.Empty> requestVerification_Pre($grpc.ServiceCall $call,
      $async.Future<$0.RequestVerificationRequest> $request) async {
    return requestVerification($call, await $request);
  }

  $async.Future<$1.Empty> requestVerification(
      $grpc.ServiceCall call, $0.RequestVerificationRequest request);
  ...
  $async.Future<$0.AuthResponse> confirmVerification(
      $grpc.ServiceCall call, $0.ConfirmVerificationRequest request);

  $async.Future<$0.GetMfaStatusResponse> getMfaStatus_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetMfaStatusRequest> $request) async {
    return getMfaStatus($call, await $request);
  }

  $async.Future<$0.GetMfaStatusResponse> getMfaStatus(
      $grpc.ServiceCall call, $0.GetMfaStatusRequest request);

  $async.Future<$0.SetupMfaResponse> setupMfa_Pre($grpc.ServiceCall $call,
      $async.Future<$0.SetupMfaRequest> $request) async {
    return setupMfa($call, await $request);
  }

  $async.Future<$0.SetupMfaResponse> setupMfa(
      $grpc.ServiceCall call, $0.SetupMfaRequest request);

  $async.Future<$0.ConfirmMfaSetupResponse> confirmMfaSetup_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ConfirmMfaSetupRequest> $request) async {
    return confirmMfaSetup($call, await $request);
  }

  $async.Future<$0.ConfirmMfaSetupResponse> confirmMfaSetup(
      $grpc.ServiceCall call, $0.ConfirmMfaSetupRequest request);

  $async.Future<$1.Empty> disableMfa_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DisableMfaRequest> $request) async {
    return disableMfa($call, await $request);
  }

  $async.Future<$1.Empty> disableMfa(
      $grpc.ServiceCall call, $0.DisableMfaRequest request);
