...
final $typed_data.Uint8List identifierTypeDescriptor = $convert.base64Decode(
    'Cg5JZGVudGlmaWVyVHlwZRIfChtJREVOVElGSUVSX1RZUEVfVU5TUEVDSUZJRUQQABIZChVJRE'
...
final $typed_data.Uint8List authStatusDescriptor = $convert.base64Decode(
    'CgpBdXRoU3RhdHVzEhsKF0FVVEhfU1RBVFVTX1VOU1BFQ0lGSUVEEAASFwoTQVVUSF9TVEFUVV'
...
final $typed_data.Uint8List verificationTypeDescriptor = $convert.base64Decode(
    'ChBWZXJpZmljYXRpb25UeXBlEiEKHVZFUklGSUNBVElPTl9UWVBFX1VOU1BFQ0lGSUVEEAASGw'
...
const ClientInfo$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.auth.v2.ClientInfo.MetadataEntry',
      '10': 'metadata'
    },
  ],
...
final $typed_data.Uint8List clientInfoDescriptor = $convert.base64Decode(
    'CgpDbGllbnRJbmZvEicKCWRldmljZV9pZBgBIAEoCUIKukgHcgUQARj/AVIIZGV2aWNlSWQSKQ'
    ...
    'RyAhhkUg1jbGllbnRWZXJzaW9uEj0KCG1ldGFkYXRhGAUgAygLMiEuYXV0aC52Mi5DbGllbnRJ'
...
final $typed_data.Uint8List userSnapshotDescriptor = $convert.base64Decode(
    'CgxVc2VyU25hcHNob3QSJgoHdXNlcl9pZBgBIAEoCzINLmNvcmUudjIuVVVJRFIGdXNlcklkEi'
    'EKDGRpc3BsYXlfbmFtZRgCIAEoCVILZGlzcGxheU5hbWUSFAoFZW1haWwYAyABKAlSBWVtYWls'
    'EhQKBXBob25lGAQgASgJUgVwaG9uZRIlCgRyb2xlGAUgASgOMhEuY29yZS52Mi5Vc2VyUm9sZV'
    'IEcm9sZRIrCgZzdGF0dXMYBiABKA4yEy5jb3JlLnYyLlVzZXJTdGF0dXNSBnN0YXR1cxIlCg5l'
    ...
    'aW5rZWRfcHJvdmlkZXJzGAogAygOMhYuYXV0aC52Mi5PQXV0aFByb3ZpZGVyUg9saW5rZWRQcm'
...
final $typed_data.Uint8List lockoutInfoDescriptor = $convert.base64Decode(
    'CgtMb2Nrb3V0SW5mbxI6CgtyZXRyeV9hZnRlchgBIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdX'
...
final $typed_data.Uint8List mfaChallengeDescriptor = $convert.base64Decode(
    'CgxNZmFDaGFsbGVuZ2USJwoPY2hhbGxlbmdlX3Rva2VuGAEgASgJUg5jaGFsbGVuZ2VUb2tlbh'
    'JDChFhdmFpbGFibGVfbWV0aG9kcxgCIAMoCzIWLmF1dGgudjIuTWZhTWV0aG9kSW5mb1IQYXZh'
...
final $typed_data.Uint8List mfaMethodInfoDescriptor = $convert.base64Decode(
    'Cg1NZmFNZXRob2RJbmZvEioKBm1ldGhvZBgBIAEoDjISLmF1dGgudjIuTWZhTWV0aG9kUgZtZX'
...
final $typed_data.Uint8List authenticateRequestDescriptor = $convert.base64Decode(
    'ChNBdXRoZW50aWNhdGVSZXF1ZXN0EioKCmlkZW50aWZpZXIYASABKAlCCrpIB3IFEAEY/gFSCm'
    'lkZW50aWZpZXISQAoPaWRlbnRpZmllcl90eXBlGAIgASgOMhcuYXV0aC52Mi5JZGVudGlmaWVy'
    'VHlwZVIOaWRlbnRpZmllclR5cGUSJgoIcGFzc3dvcmQYAyABKAlCCrpIB3IFEAEYgAFSCHBhc3'
    'N3b3JkEj4KD2luc3RhbGxhdGlvbl9pZBgEIAEoCzINLmNvcmUudjIuVVVJREIGukgDyAEBUg5p'
    'bnN0YWxsYXRpb25JZBI8CgtjbGllbnRfaW5mbxgFIAEoCzITLmF1dGgudjIuQ2xpZW50SW5mb0'
...
final $typed_data.Uint8List authResponseDescriptor = $convert.base64Decode(
    'CgxBdXRoUmVzcG9uc2USKwoGc3RhdHVzGAEgASgOMhMuYXV0aC52Mi5BdXRoU3RhdHVzUgZzdG'
    'F0dXMSKgoGdG9rZW5zGAIgASgLMhIuYXV0aC52Mi5Ub2tlblBhaXJSBnRva2VucxIpCgR1c2Vy'
    'GAMgASgLMhUuYXV0aC52Mi5Vc2VyU25hcHNob3RSBHVzZXISOgoNbWZhX2NoYWxsZW5nZRgEIA'
    'EoCzIVLmF1dGgudjIuTWZhQ2hhbGxlbmdlUgxtZmFDaGFsbGVuZ2USNwoMbG9ja291dF9pbmZv'
    'GAUgASgLMhQuYXV0aC52Mi5Mb2Nrb3V0SW5mb1ILbG9ja291dEluZm8SGAoHbWVzc2FnZRgGIA'
    'EoCVIHbWVzc2FnZQ==');
...
final $typed_data.Uint8List signUpRequestDescriptor = $convert.base64Decode(
    'Cg1TaWduVXBSZXF1ZXN0EioKCmlkZW50aWZpZXIYASABKAlCCrpIB3IFEAEY/gFSCmlkZW50aW'
    'ZpZXISQAoPaWRlbnRpZmllcl90eXBlGAIgASgOMhcuYXV0aC52Mi5JZGVudGlmaWVyVHlwZVIO'
    ...
    'bGF0aW9uX2lkGAUgASgLMg0uY29yZS52Mi5VVUlEQga6SAPIAQFSDmluc3RhbGxhdGlvbklkEj'
    'wKC2NsaWVudF9pbmZvGAYgASgLMhMuYXV0aC52Mi5DbGllbnRJbmZvQga6SAPIAQFSCmNsaWVu'
...
final $typed_data.Uint8List refreshTokensRequestDescriptor = $convert.base64Decode(
    'ChRSZWZyZXNoVG9rZW5zUmVxdWVzdBIsCg1yZWZyZXNoX3Rva2VuGAEgASgJQge6SARyAhABUg'
    'xyZWZyZXNoVG9rZW4=');
...
final $typed_data.Uint8List validateCredentialsResponseDescriptor =
    $convert.base64Decode(
        'ChtWYWxpZGF0ZUNyZWRlbnRpYWxzUmVzcG9uc2USFAoFdmFsaWQYASABKAhSBXZhbGlkEikKBH'
        'VzZXIYAiABKAsyFS5hdXRoLnYyLlVzZXJTbmFwc2hvdFIEdXNlcg==');
...
final $typed_data.Uint8List signOutRequestDescriptor =
    $convert.base64Decode('Cg5TaWduT3V0UmVxdWVzdA==');
...
final $typed_data.Uint8List getOAuthUrlRequestDescriptor = $convert.base64Decode(
    'ChJHZXRPQXV0aFVybFJlcXVlc3QSPAoIcHJvdmlkZXIYASABKA4yFi5hdXRoLnYyLk9BdXRoUH'
...
final $typed_data.Uint8List getOAuthUrlResponseDescriptor = $convert.base64Decode(
    'ChNHZXRPQXV0aFVybFJlc3BvbnNlEisKEWF1dGhvcml6YXRpb25fdXJsGAEgASgJUhBhdXRob3'
...
final $typed_data.Uint8List exchangeOAuthCodeRequestDescriptor = $convert.base64Decode(
    'ChhFeGNoYW5nZU9BdXRoQ29kZVJlcXVlc3QSGwoEY29kZRgBIAEoCUIHukgEcgIQAVIEY29kZR'
    'IdCgVzdGF0ZRgCIAEoCUIHukgEcgIQAVIFc3RhdGUSPgoPaW5zdGFsbGF0aW9uX2lkGAMgASgL'
    'Mg0uY29yZS52Mi5VVUlEQga6SAPIAQFSDmluc3RhbGxhdGlvbklkEjwKC2NsaWVudF9pbmZvGA'
    'QgASgLMhMuYXV0aC52Mi5DbGllbnRJbmZvQga6SAPIAQFSCmNsaWVudEluZm8=');
...
final $typed_data.Uint8List linkOAuthProviderRequestDescriptor =
    $convert.base64Decode(
        'ChhMaW5rT0F1dGhQcm92aWRlclJlcXVlc3QSGwoEY29kZRgBIAEoCUIHukgEcgIQAVIEY29kZR'
...
final $typed_data.Uint8List unlinkOAuthProviderRequestDescriptor =
    $convert.base64Decode(
        'ChpVbmxpbmtPQXV0aFByb3ZpZGVyUmVxdWVzdBI8Cghwcm92aWRlchgBIAEoDjIWLmF1dGgudj'
        'IuT0F1dGhQcm92aWRlckIIukgFggECIABSCHByb3ZpZGVy');
...
final $typed_data.Uint8List listLinkedProvidersResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0TGlua2VkUHJvdmlkZXJzUmVzcG9uc2USNQoJcHJvdmlkZXJzGAEgAygLMhcuYXV0aC'
        '52Mi5MaW5rZWRQcm92aWRlclIJcHJvdmlkZXJz');
...
final $typed_data.Uint8List linkedProviderDescriptor = $convert.base64Decode(
    'Cg5MaW5rZWRQcm92aWRlchIyCghwcm92aWRlchgBIAEoDjIWLmF1dGgudjIuT0F1dGhQcm92aW'
...
final $typed_data.Uint8List recoveryStartRequestDescriptor = $convert.base64Decode(
    'ChRSZWNvdmVyeVN0YXJ0UmVxdWVzdBIqCgppZGVudGlmaWVyGAEgASgJQgq6SAdyBRABGP4BUg'
    'ppZGVudGlmaWVyEkAKD2lkZW50aWZpZXJfdHlwZRgCIAEoDjIXLmF1dGgudjIuSWRlbnRpZmll'
...
final $typed_data.Uint8List recoveryConfirmRequestDescriptor =
    $convert.base64Decode(
        'ChZSZWNvdmVyeUNvbmZpcm1SZXF1ZXN0Eh0KBXRva2VuGAEgASgJQge6SARyAhABUgV0b2tlbh'
...
final $typed_data.Uint8List changePasswordRequestDescriptor = $convert.base64Decode(
    'ChVDaGFuZ2VQYXNzd29yZFJlcXVlc3QSMgoQY3VycmVudF9wYXNzd29yZBgBIAEoCUIHukgEcg'
...
final $typed_data.Uint8List requestVerificationRequestDescriptor =
    $convert.base64Decode(
        'ChpSZXF1ZXN0VmVyaWZpY2F0aW9uUmVxdWVzdBI3CgR0eXBlGAEgASgOMhkuYXV0aC52Mi5WZX'
...
final $typed_data.Uint8List confirmVerificationRequestDescriptor = $convert.base64Decode(
    'ChpDb25maXJtVmVyaWZpY2F0aW9uUmVxdWVzdBIdCgV0b2tlbhgBIAEoCUIHukgEcgIQAVIFdG'
    '9rZW4SNwoEdHlwZRgCIAEoDjIZLmF1dGgudjIuVmVyaWZpY2F0aW9uVHlwZUIIukgFggECIABS'
    'BHR5cGUSPgoPaW5zdGFsbGF0aW9uX2lkGAMgASgLMg0uY29yZS52Mi5VVUlEQga6SAPIAQFSDm'
    'luc3RhbGxhdGlvbklkEjwKC2NsaWVudF9pbmZvGAQgASgLMhMuYXV0aC52Mi5DbGllbnRJbmZv'
...
final $typed_data.Uint8List getMfaStatusRequestDescriptor =
    $convert.base64Decode('ChNHZXRNZmFTdGF0dXNSZXF1ZXN0');
...
const GetMfaStatusResponse$json = {
  ...
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.auth.v2.MfaMethodStatus',
      '10': 'methods'
    },
    {
      '1': 'recovery_codes_remaining',
      '3': 3,
      '4': 1,
      '5': 5,
      '10': 'recoveryCodesRemaining'
    },
  ],
};

/// Descriptor for `GetMfaStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMfaStatusResponseDescriptor = $convert.base64Decode(
    'ChRHZXRNZmFTdGF0dXNSZXNwb25zZRIYCgdlbmFibGVkGAEgASgIUgdlbmFibGVkEjIKB21ldG'
    'hvZHMYAiADKAsyGC5hdXRoLnYyLk1mYU1ldGhvZFN0YXR1c1IHbWV0aG9kcxI4ChhyZWNvdmVy'
...
final $typed_data.Uint8List mfaMethodStatusDescriptor = $convert.base64Decode(
    'Cg9NZmFNZXRob2RTdGF0dXMSKgoGbWV0aG9kGAEgASgOMhIuYXV0aC52Mi5NZmFNZXRob2RSBm'
...
final $typed_data.Uint8List setupMfaRequestDescriptor = $convert.base64Decode(
    'Cg9TZXR1cE1mYVJlcXVlc3QSNAoGbWV0aG9kGAEgASgOMhIuYXV0aC52Mi5NZmFNZXRob2RCCL'
...
final $typed_data.Uint8List setupMfaResponseDescriptor = $convert.base64Decode(
    'ChBTZXR1cE1mYVJlc3BvbnNlEhYKBnNlY3JldBgBIAEoCVIGc2VjcmV0EikKEHByb3Zpc2lvbm'
...
final $typed_data.Uint8List confirmMfaSetupRequestDescriptor =
    $convert.base64Decode(
        'ChZDb25maXJtTWZhU2V0dXBSZXF1ZXN0EigKC3NldHVwX3Rva2VuGAEgASgJQge6SARyAhABUg'
...
final $typed_data.Uint8List confirmMfaSetupResponseDescriptor = $convert.base64Decode(
    'ChdDb25maXJtTWZhU2V0dXBSZXNwb25zZRI0CgdzdWNjZXNzGAEgASgLMhguYXV0aC52Mi5NZm'
    'FTZXR1cFN1Y2Nlc3NIAFIHc3VjY2VzcxIuCgVlcnJvchgCIAEoCzIWLmF1dGgudjIuTWZhU2V0'
...
final $typed_data.Uint8List mfaSetupSuccessDescriptor = $convert.base64Decode(
    'Cg9NZmFTZXR1cFN1Y2Nlc3MSJQoOcmVjb3ZlcnlfY29kZXMYASADKAlSDXJlY292ZXJ5Q29kZX'
    'M=');
...
final $typed_data.Uint8List mfaSetupErrorDescriptor = $convert.base64Decode(
    'Cg1NZmFTZXR1cEVycm9yEhgKB21lc3NhZ2UYASABKAlSB21lc3NhZ2USEgoEY29kZRgCIAEoCV'
    'IEY29kZQ==');
...
final $typed_data.Uint8List disableMfaRequestDescriptor = $convert.base64Decode(
    'ChFEaXNhYmxlTWZhUmVxdWVzdBIqCgZtZXRob2QYASABKA4yEi5hdXRoLnYyLk1mYU1ldGhvZF'
...
final $typed_data.Uint8List listSessionsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2Vzc2lvbnNSZXNwb25zZRIwCghzZXNzaW9ucxgBIAMoCzIULmF1dGgudjIuU2Vzc2'
...
const SessionInfo$json = {
  ...
  '2': [
    ...
    {'1': 'activity_count', '3': 12, '4': 1, '5': 5, '10': 'activityCount'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.auth.v2.SessionInfo.MetadataEntry',
      '10': 'metadata'
    },
  ],
...
final $typed_data.Uint8List sessionInfoDescriptor = $convert.base64Decode(
    'CgtTZXNzaW9uSW5mbxIbCglkZXZpY2VfaWQYASABKAlSCGRldmljZUlkEh8KC2RldmljZV9uYW'
    ...
    '1ldGFkYXRhGA0gAygLMiIuYXV0aC52Mi5TZXNzaW9uSW5mby5NZXRhZGF0YUVudHJ5UghtZXRh'
...
final $typed_data.Uint8List revokeSessionRequestDescriptor = $convert.base64Decode(
    'ChRSZXZva2VTZXNzaW9uUmVxdWVzdBInCglkZXZpY2VfaWQYASABKAlCCrpIB3IFEAEY/wFSCG'
    'RldmljZUlk');
...
final $typed_data.Uint8List revokeSessionsResponseDescriptor =
    $convert.base64Decode(
        'ChZSZXZva2VTZXNzaW9uc1Jlc3BvbnNlEiMKDXJldm9rZWRfY291bnQYASABKAVSDHJldm9rZW'
        'RDb3VudA==');
