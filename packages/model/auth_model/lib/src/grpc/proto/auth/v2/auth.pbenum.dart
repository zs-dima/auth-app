...
class OAuthProvider extends $pb.ProtobufEnum {
  ...
  static const OAuthProvider OAUTH_PROVIDER_GITHUB =
      OAuthProvider._(2, _omitEnumNames ? '' : 'OAUTH_PROVIDER_GITHUB');
  ...
  static const OAuthProvider OAUTH_PROVIDER_APPLE =
      OAuthProvider._(4, _omitEnumNames ? '' : 'OAUTH_PROVIDER_APPLE');
...
class AuthStatus extends $pb.ProtobufEnum {
  ...
  static const AuthStatus AUTH_STATUS_SUCCESS =
      AuthStatus._(1, _omitEnumNames ? '' : 'AUTH_STATUS_SUCCESS');
  static const AuthStatus AUTH_STATUS_MFA_REQUIRED =
      AuthStatus._(2, _omitEnumNames ? '' : 'AUTH_STATUS_MFA_REQUIRED');
  static const AuthStatus AUTH_STATUS_FAILED =
      AuthStatus._(3, _omitEnumNames ? '' : 'AUTH_STATUS_FAILED');
  static const AuthStatus AUTH_STATUS_LOCKED =
      AuthStatus._(4, _omitEnumNames ? '' : 'AUTH_STATUS_LOCKED');
  static const AuthStatus AUTH_STATUS_SUSPENDED =
      AuthStatus._(5, _omitEnumNames ? '' : 'AUTH_STATUS_SUSPENDED');
  static const AuthStatus AUTH_STATUS_PENDING =
      AuthStatus._(6, _omitEnumNames ? '' : 'AUTH_STATUS_PENDING');
...
class VerificationType extends $pb.ProtobufEnum {
  static const VerificationType VERIFICATION_TYPE_UNSPECIFIED =
      VerificationType._(
          0, _omitEnumNames ? '' : 'VERIFICATION_TYPE_UNSPECIFIED');
  ...
  static final $core.List<VerificationType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static VerificationType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MfaMethod extends $pb.ProtobufEnum {
  ...
  static const MfaMethod MFA_METHOD_SMS =
      MfaMethod._(2, _omitEnumNames ? '' : 'MFA_METHOD_SMS');
  ...
  static const MfaMethod MFA_METHOD_RECOVERY_CODE =
      MfaMethod._(4, _omitEnumNames ? '' : 'MFA_METHOD_RECOVERY_CODE');
