...
import 'package:protobuf/well_known_types/google/protobuf/duration.pb.dart' as $2;
...
import '../../core/v1/core.pb.dart' as $1;
...
class UserSnapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserSnapshot',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'auth.v1'), createEmptyInstance: create)
    ..aOM<$1.UUID>(1, _omitFieldNames ? '' : 'userId', subBuilder: $1.UUID.create)
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOS(3, _omitFieldNames ? '' : 'email')
    ..aOS(4, _omitFieldNames ? '' : 'phone')
    ..aE<$1.UserRole>(5, _omitFieldNames ? '' : 'role', enumValues: $1.UserRole.values)
    ..aE<$1.UserStatus>(6, _omitFieldNames ? '' : 'status', enumValues: $1.UserStatus.values)
  ...
  @$pb.TagNumber(1)
  $1.UUID get userId => $_getN(0);
  @$pb.TagNumber(1)
  set userId($1.UUID value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasUserId() => $_has(0);
  @$pb.TagNumber(1)
  void clearUserId() => $_clearField(1);
  @$pb.TagNumber(1)
  $1.UUID ensureUserId() => $_ensure(0);
...
class LockoutInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LockoutInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'auth.v1'), createEmptyInstance: create)
    ..aOM<$2.Duration>(1, _omitFieldNames ? '' : 'retryAfter', subBuilder: $2.Duration.create)
    ..aI(2, _omitFieldNames ? '' : 'failedAttempts')
    ..aI(3, _omitFieldNames ? '' : 'maxAttempts')
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'lockedUntil', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $2.Duration get retryAfter => $_getN(0);
  @$pb.TagNumber(1)
  set retryAfter($2.Duration value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasRetryAfter() => $_has(0);
  @$pb.TagNumber(1)
  void clearRetryAfter() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.Duration ensureRetryAfter() => $_ensure(0);
  ...
  /// Lockout timestamp
  @$pb.TagNumber(4)
  $0.Timestamp get lockedUntil => $_getN(3);
  @$pb.TagNumber(4)
  set lockedUntil($0.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasLockedUntil() => $_has(3);
  @$pb.TagNumber(4)
  void clearLockedUntil() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureLockedUntil() => $_ensure(3);
}
...
class AuthenticateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthenticateRequest',
    ...
    ..aOM<$1.UUID>(4, _omitFieldNames ? '' : 'installationId', subBuilder: $1.UUID.create)
  ...
  @$pb.TagNumber(4)
  $1.UUID get installationId => $_getN(3);
  @$pb.TagNumber(4)
  set installationId($1.UUID value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasInstallationId() => $_has(3);
  @$pb.TagNumber(4)
  void clearInstallationId() => $_clearField(4);
  @$pb.TagNumber(4)
  $1.UUID ensureInstallationId() => $_ensure(3);
...
class SignUpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SignUpRequest',
    ...
    ..aOM<$1.UUID>(5, _omitFieldNames ? '' : 'installationId', subBuilder: $1.UUID.create)
  ...
  @$pb.TagNumber(5)
  $1.UUID get installationId => $_getN(4);
  @$pb.TagNumber(5)
  set installationId($1.UUID value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasInstallationId() => $_has(4);
  @$pb.TagNumber(5)
  void clearInstallationId() => $_clearField(5);
  @$pb.TagNumber(5)
  $1.UUID ensureInstallationId() => $_ensure(4);
...
class ExchangeOAuthCodeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExchangeOAuthCodeRequest',
    ...
    ..aOS(2, _omitFieldNames ? '' : 'state')
    ..aOM<$1.UUID>(3, _omitFieldNames ? '' : 'installationId', subBuilder: $1.UUID.create)
    ..aOM<ClientInfo>(4, _omitFieldNames ? '' : 'clientInfo', subBuilder: ClientInfo.create)
    ..hasRequiredFields = false;
  ...
  /// Installation ID
  @$pb.TagNumber(3)
  $1.UUID get installationId => $_getN(2);
  @$pb.TagNumber(3)
  set installationId($1.UUID value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasInstallationId() => $_has(2);
  @$pb.TagNumber(3)
  void clearInstallationId() => $_clearField(3);
  @$pb.TagNumber(3)
  $1.UUID ensureInstallationId() => $_ensure(2);
...
class LinkedProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LinkedProvider',
    ...
    ..aOS(3, _omitFieldNames ? '' : 'email')
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'linkedAt', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $0.Timestamp get linkedAt => $_getN(3);
  @$pb.TagNumber(4)
  set linkedAt($0.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasLinkedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearLinkedAt() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureLinkedAt() => $_ensure(3);
}
...
class MfaMethodStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MfaMethodStatus',
    ...
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'configuredAt', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $0.Timestamp get configuredAt => $_getN(3);
  @$pb.TagNumber(4)
  set configuredAt($0.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasConfiguredAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearConfiguredAt() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureConfiguredAt() => $_ensure(3);
}
...
class SessionInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionInfo',
    ...
    ..aOM<$0.Timestamp>(8, _omitFieldNames ? '' : 'lastSeenAt', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(9, _omitFieldNames ? '' : 'expiresAt', subBuilder: $0.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $0.Timestamp get lastSeenAt => $_getN(7);
  @$pb.TagNumber(8)
  set lastSeenAt($0.Timestamp value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasLastSeenAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearLastSeenAt() => $_clearField(8);
  @$pb.TagNumber(8)
  $0.Timestamp ensureLastSeenAt() => $_ensure(7);
...
class AuthServiceApi {
  ...
  $async.Future<AuthResponse> authenticate($pb.ClientContext? ctx, AuthenticateRequest request) =>
      _client.invoke<AuthResponse>(ctx, 'AuthService', 'Authenticate', request, AuthResponse());
  ...
  ///
  /// Public endpoint — no authentication required.
  $async.Future<TokenPair> refreshTokens($pb.ClientContext? ctx, RefreshTokensRequest request) =>
      _client.invoke<TokenPair>(ctx, 'AuthService', 'RefreshTokens', request, TokenPair());

  /// Validate current session/credentials
  $async.Future<ValidateCredentialsResponse> validateCredentials(
          $pb.ClientContext? ctx, ValidateCredentialsRequest request) =>
      _client.invoke<ValidateCredentialsResponse>(
          ctx, 'AuthService', 'ValidateCredentials', request, ValidateCredentialsResponse());

  /// Sign out and invalidate current session
  $async.Future<$3.Empty> signOut($pb.ClientContext? ctx, SignOutRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'SignOut', request, $3.Empty());
  ...
  ///
  /// Public endpoint — no authentication required.
  $async.Future<AuthResponse> signUp($pb.ClientContext? ctx, SignUpRequest request) =>
      _client.invoke<AuthResponse>(ctx, 'AuthService', 'SignUp', request, AuthResponse());
  ...
  $async.Future<AuthResponse> verifyMfa($pb.ClientContext? ctx, VerifyMfaRequest request) =>
      _client.invoke<AuthResponse>(ctx, 'AuthService', 'VerifyMfa', request, AuthResponse());

  /// Get OAuth authorization URL with PKCE state
  ///
  /// Public endpoint — no authentication required.
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<GetOAuthUrlResponse> getOAuthUrl($pb.ClientContext? ctx, GetOAuthUrlRequest request) =>
      _client.invoke<GetOAuthUrlResponse>(ctx, 'AuthService', 'GetOAuthUrl', request, GetOAuthUrlResponse());

  /// Exchange OAuth callback code for tokens (login or register)
  ///
  /// Public endpoint — no authentication required.
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<AuthResponse> exchangeOAuthCode($pb.ClientContext? ctx, ExchangeOAuthCodeRequest request) =>
      _client.invoke<AuthResponse>(ctx, 'AuthService', 'ExchangeOAuthCode', request, AuthResponse());

  /// Link OAuth provider to existing authenticated account
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<$3.Empty> linkOAuthProvider($pb.ClientContext? ctx, LinkOAuthProviderRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'LinkOAuthProvider', request, $3.Empty());

  /// Unlink OAuth provider from account
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<$3.Empty> unlinkOAuthProvider($pb.ClientContext? ctx, UnlinkOAuthProviderRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'UnlinkOAuthProvider', request, $3.Empty());

  /// List linked OAuth providers for current user
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<ListLinkedProvidersResponse> listLinkedProviders(
          $pb.ClientContext? ctx, ListLinkedProvidersRequest request) =>
      _client.invoke<ListLinkedProvidersResponse>(
          ctx, 'AuthService', 'ListLinkedProviders', request, ListLinkedProvidersResponse());
  ...
  ///
  /// Public endpoint — no authentication required.
  $async.Future<$3.Empty> recoveryStart($pb.ClientContext? ctx, RecoveryStartRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'RecoveryStart', request, $3.Empty());

  /// Confirm recovery with token and set new password
  ///
  /// Public endpoint — no authentication required.
  $async.Future<$3.Empty> recoveryConfirm($pb.ClientContext? ctx, RecoveryConfirmRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'RecoveryConfirm', request, $3.Empty());
  ...
  $async.Future<$3.Empty> changePassword($pb.ClientContext? ctx, ChangePasswordRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'ChangePassword', request, $3.Empty());

  /// Request verification code for email or phone (resend)
  $async.Future<$3.Empty> requestVerification($pb.ClientContext? ctx, RequestVerificationRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'RequestVerification', request, $3.Empty());

  /// Confirm verification with token - returns auth tokens for seamless login
  ///
  /// Public endpoint — no authentication required.
  $async.Future<AuthResponse> confirmVerification($pb.ClientContext? ctx, ConfirmVerificationRequest request) =>
      _client.invoke<AuthResponse>(ctx, 'AuthService', 'ConfirmVerification', request, AuthResponse());

  /// Get current MFA status for user
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<GetMfaStatusResponse> getMfaStatus($pb.ClientContext? ctx, GetMfaStatusRequest request) =>
      _client.invoke<GetMfaStatusResponse>(ctx, 'AuthService', 'GetMfaStatus', request, GetMfaStatusResponse());

  /// Begin MFA setup (returns secret/challenge based on method)
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<SetupMfaResponse> setupMfa($pb.ClientContext? ctx, SetupMfaRequest request) =>
      _client.invoke<SetupMfaResponse>(ctx, 'AuthService', 'SetupMfa', request, SetupMfaResponse());

  /// Confirm MFA setup with verification code
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<ConfirmMfaSetupResponse> confirmMfaSetup($pb.ClientContext? ctx, ConfirmMfaSetupRequest request) =>
      _client.invoke<ConfirmMfaSetupResponse>(
          ctx, 'AuthService', 'ConfirmMfaSetup', request, ConfirmMfaSetupResponse());

  /// Disable MFA (requires password verification)
  ///
  /// Status: NOT IMPLEMENTED — the server currently returns UNIMPLEMENTED.
  $async.Future<$3.Empty> disableMfa($pb.ClientContext? ctx, DisableMfaRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'DisableMfa', request, $3.Empty());
  ...
  $async.Future<ListSessionsResponse> listSessions($pb.ClientContext? ctx, ListSessionsRequest request) =>
      _client.invoke<ListSessionsResponse>(ctx, 'AuthService', 'ListSessions', request, ListSessionsResponse());

  /// Revoke a specific session by device_id
  $async.Future<$3.Empty> revokeSession($pb.ClientContext? ctx, RevokeSessionRequest request) =>
      _client.invoke<$3.Empty>(ctx, 'AuthService', 'RevokeSession', request, $3.Empty());

  /// Revoke all sessions except current
  $async.Future<RevokeSessionsResponse> revokeOtherSessions(
          $pb.ClientContext? ctx, RevokeOtherSessionsRequest request) =>
      _client.invoke<RevokeSessionsResponse>(
          ctx, 'AuthService', 'RevokeOtherSessions', request, RevokeSessionsResponse());
}
