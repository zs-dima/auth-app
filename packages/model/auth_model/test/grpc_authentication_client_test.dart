...
import 'package:auth_model/src/grpc/grpc_authentication_client.dart';
import 'package:auth_model/src/grpc/proto/auth/v2/auth.pb.dart' as rpc;
...
void main() {
  group('GrpcAuthenticationClient.mapRefreshResponse (refresh-token rotation — RFC 6749 §6)', () {
    test('keeps the previous refresh token when the response omits a rotated one', () {
      ...
      final creds = GrpcAuthenticationClient.mapRefreshResponse(result, const RefreshToken('old-refresh'));
