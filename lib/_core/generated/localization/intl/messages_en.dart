...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "appTitle": MessageLookupByLibrary.simpleMessage("Auth app"),
    ...
    "errAnErrorHasOccurred": MessageLookupByLibrary.simpleMessage(
      "An error has occurred",
    ),
    "errAnExceptionHasOccurred": MessageLookupByLibrary.simpleMessage(
      "An exception has occurred",
    ),
    "errAssertionError": MessageLookupByLibrary.simpleMessage(
      "Assertion error",
    ),
    "errFileSystemException": MessageLookupByLibrary.simpleMessage(
      "File system error",
    ),
    "errInvalidFormat": MessageLookupByLibrary.simpleMessage("Invalid format"),
    "errNotImplementedYet": MessageLookupByLibrary.simpleMessage(
      "Not implemented yet",
    ),
    "errTimeOutExceeded": MessageLookupByLibrary.simpleMessage(
      "Time out exceeded",
    ),
    "errUnsupportedOperation": MessageLookupByLibrary.simpleMessage(
