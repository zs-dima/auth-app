...
class _ShimmerState extends State<Shimmer> with SingleTickerProviderStateMixin {
  /// Init shader.
  static Future<ui.FragmentShader?> get _shaderFuture async {
    try {
      final program = await ui.FragmentProgram.fromAsset('assets/shaders/shimmer.frag');
