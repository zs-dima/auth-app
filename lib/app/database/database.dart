...
import 'package:auth_app/app/database/platform/database.dart';
import 'package:auth_app/app/database/queries.dart';
...
class DatabaseMigrationStrategy implements MigrationStrategy {
  ...
  @override
  OnBeforeOpen get beforeOpen => (details) => Future.value();
