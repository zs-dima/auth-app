...
class EnvironmentLoader {
  ...
  Future<AppEnvironment> call() => _$currentLoading ??= Future<AppEnvironment>(() async {
        try {
          ...
          final env = dockerEnv.environment ??
          ...
          final dropDatabase = dockerEnv.dropDatabase ??
              const bool.fromEnvironment(EnvironmentVariables.dropDatabase, defaultValue: false);
          final databaseName = dockerEnv.databaseName ?? //
              const String.fromEnvironment(EnvironmentVariables.databaseName, defaultValue: 'sqlite');
          final inMemoryDatabase = dockerEnv.inMemoryDatabase ??
