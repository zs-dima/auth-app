...
sealed class AuthenticationState extends _$AuthenticationStateBase {
  ...
  /// Idling state
  /// {@macro authentication_state}
  const factory AuthenticationState.idle({required AuthUser user, String message, String? error}) =
      AuthenticationState$Idle;

  /// Processing
  /// {@macro authentication_state}
  const factory AuthenticationState.processing({required AuthUser user, String message}) =
