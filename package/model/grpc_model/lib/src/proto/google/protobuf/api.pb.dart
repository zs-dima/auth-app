...
import 'package:protobuf/well_known_types/google/protobuf/source_context.pb.dart' as $1;
...
class Api extends $pb.GeneratedMessage {
  ...
  factory Api.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Api.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Api',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..pPM<Method>(2, _omitFieldNames ? '' : 'methods', subBuilder: Method.create)
    ..pPM<$0.Option>(3, _omitFieldNames ? '' : 'options', subBuilder: $0.Option.create)
    ...
    ..aE<$0.Syntax>(7, _omitFieldNames ? '' : 'syntax', enumValues: $0.Syntax.values)
...
class Method extends $pb.GeneratedMessage {
  ...
  factory Method.fromBuffer($core.List<$core.int> data,
      ...
      create()..mergeFromBuffer(data, registry);
  factory Method.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Method',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ...
    ..pPM<$0.Option>(6, _omitFieldNames ? '' : 'options', subBuilder: $0.Option.create)
    ..aE<$0.Syntax>(7, _omitFieldNames ? '' : 'syntax', enumValues: $0.Syntax.values)
    ..hasRequiredFields = false;
...
class Mixin extends $pb.GeneratedMessage {
  ...
  factory Mixin.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Mixin.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mixin',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
