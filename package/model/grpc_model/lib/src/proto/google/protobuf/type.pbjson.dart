...
final $typed_data.Uint8List typeDescriptor =
    $convert.base64Decode('CgRUeXBlEhIKBG5hbWUYASABKAlSBG5hbWUSLgoGZmllbGRzGAIgAygLMhYuZ29vZ2xlLnByb3'
...
final $typed_data.Uint8List fieldDescriptor =
    $convert.base64Decode('CgVGaWVsZBIvCgRraW5kGAEgASgOMhsuZ29vZ2xlLnByb3RvYnVmLkZpZWxkLktpbmRSBGtpbm'
...
final $typed_data.Uint8List enumDescriptor =
    $convert.base64Decode('CgRFbnVtEhIKBG5hbWUYASABKAlSBG5hbWUSOAoJZW51bXZhbHVlGAIgAygLMhouZ29vZ2xlLn'
...
final $typed_data.Uint8List enumValueDescriptor =
    $convert.base64Decode('CglFbnVtVmFsdWUSEgoEbmFtZRgBIAEoCVIEbmFtZRIWCgZudW1iZXIYAiABKAVSBm51bWJlch'
...
final $typed_data.Uint8List optionDescriptor =
    $convert.base64Decode('CgZPcHRpb24SEgoEbmFtZRgBIAEoCVIEbmFtZRIqCgV2YWx1ZRgCIAEoCzIULmdvb2dsZS5wcm'
