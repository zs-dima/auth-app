...
import 'package:protobuf/well_known_types/google/protobuf/source_context.pb.dart' as $0;
...
class Type extends $pb.GeneratedMessage {
  ...
  factory Type.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Type.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type',
    ...
    ..pPM<Option>(4, _omitFieldNames ? '' : 'options', subBuilder: Option.create)
...
class Field extends $pb.GeneratedMessage {
  ...
  factory Field.fromBuffer($core.List<$core.int> data,
      ...
      create()..mergeFromBuffer(data, registry);
  factory Field.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aE<Field_Kind>(1, _omitFieldNames ? '' : 'kind', enumValues: Field_Kind.values)
    ..aE<Field_Cardinality>(2, _omitFieldNames ? '' : 'cardinality', enumValues: Field_Cardinality.values)
    ..aI(3, _omitFieldNames ? '' : 'number')
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..aOS(6, _omitFieldNames ? '' : 'typeUrl')
    ..aI(7, _omitFieldNames ? '' : 'oneofIndex')
    ..aOB(8, _omitFieldNames ? '' : 'packed')
    ..pPM<Option>(9, _omitFieldNames ? '' : 'options', subBuilder: Option.create)
...
class Enum extends $pb.GeneratedMessage {
  ...
  factory Enum.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Enum.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..pPM<EnumValue>(2, _omitFieldNames ? '' : 'enumvalue', subBuilder: EnumValue.create)
    ..pPM<Option>(3, _omitFieldNames ? '' : 'options', subBuilder: Option.create)
...
class EnumValue extends $pb.GeneratedMessage {
  ...
  factory EnumValue.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory EnumValue.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnumValue',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class Option extends $pb.GeneratedMessage {
  ...
  factory Option.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Option.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
